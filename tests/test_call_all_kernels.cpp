#include "../include/kaad/functions/kernels.hpp"      // for Kernls
#include "../include/kaad/functions/safe_kernels.hpp" // for Kernls
#include "../include/kaad/scalar.hpp"                 // for kaad::Scalar
